...
class user extends MY_Controller {	
	...
	function view_all() {
		...
		$data = array(
			'application' => 'MWP',
			'page' => 'View All News',
			'navigation' => $this->load->view('nav/user', '', true),
			'content' => $this->load->view('content/user/view_all', $content_data, true),
	...
	function add()
	{
		$data = array(
			'application' => 'MWP',
			'page' => 'Add User',			//TOCHANGE: ganti dengan nama halaman yang sesuai
			'navigation' => $this->load->view('nav/user', '', true),
			'content' => $this->load->view('content/user/add', '', true),
		);
		$this->load->view('layout/default', $data);
	}
	...
	{	
		...
		if($this->$model->get_from_username($data['username'])){
			$this->session->set_flashdata('error', 'Username you entered exist. Please try another!');
			redirect('user/add');
		}
	...
	function update($id)
	{
		...
		$data = array(
			'application' => 'MWP',
			'page' => 'Update User',		//TOCHANGE: ganti dengan nama halaman yang sesuai
			'navigation' => $this->load->view('nav/user', '', true),
			'content' => $this->load->view('content/user/update', $content_data, true),
