...
<script>
	$(document).ready(function() {
		...
		function updateRowValue($currency, $ask, $bid, $highAsk, $highBid, $lowAsk, $lowBid) {
			...
			if($ask > $lastAsk){
				$("<img src='<?php echo $baseurl; ?>assets/img/blue.png'>").appendTo('#ask-' + $currency);
			}
			if($ask < $lastAsk){
				$("<img src='<?php echo $baseurl; ?>assets/img/red.png'>").appendTo('#ask-' + $currency);
			}
			if($highAsk > $lastHighAsk){
				$("<img src='<?php echo $baseurl; ?>assets/img/blue.png'>").appendTo('#highask-' + $currency);
			}
			if($highAsk < $lastHighAsk){
				$("<img src='<?php echo $baseurl; ?>assets/img/red.png'>").appendTo('#highask-' + $currency);
			}
			if($lowAsk > $lastLowAsk){
				$("<img src='<?php echo $baseurl; ?>assets/img/blue.png'>").appendTo('#lowask-' + $currency);
			}
			if($lowAsk < $lastLowAsk){
				$("<img src='<?php echo $baseurl; ?>assets/img/red.png'>").appendTo('#lowask-' + $currency);
			}
			if($bid > $lastBid){
				$("<img src='<?php echo $baseurl; ?>assets/img/blue.png'>").appendTo('#bid-' + $currency);
			}
			if($bid < $lastBid){
				$("<img src='<?php echo $baseurl; ?>assets/img/red.png'>").appendTo('#bid-' + $currency);
			}
			if($highBid > $lastHighBid){
				$("<img src='<?php echo $baseurl; ?>assets/img/blue.png'>").appendTo('#highbid-' + $currency);
			}
			if($highBid < $lastHighBid){
				$("<img src='<?php echo $baseurl; ?>assets/img/red.png'>").appendTo('#highbid-' + $currency);
			}
			if($lowBid > $lastLowBid){
				$("<img src='<?php echo $baseurl; ?>assets/img/blue.png'>").appendTo('#lowbid-' + $currency);
			}
			if($lowBid < $lastLowBid){
				$("<img src='<?php echo $baseurl; ?>assets/img/red.png'>").appendTo('#lowbid-' + $currency);
			}
		}
